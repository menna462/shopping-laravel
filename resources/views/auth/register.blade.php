      ...
      <div class="row align-items-center h-100">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" method="POST" action="{{ route('register') }}">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" :value="old('name')"  id="inputEmail" class="form-control form-control-lg" placeholder="name" required="" autofocus="">
          </div>
          <div class="form-group">
            <label for="inputEmail" class="sr-only">Email address</label>
            <input type="email" id="inputEmail" name="email" :value="old('email')" class="form-control form-control-lg" placeholder="Email address" required="" autofocus="">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="inputPassword" class="sr-only">Conferm password</label>
            <input type="password" id="inputPassword"  name="password_confirmation" class="form-control form-control-lg" placeholder="password_confirmation" required="">
          </div>
